...
train_example1 = Example(question="What was the name of the young boy in the story?", answer="Philemon")
train_example2 = Example(question="What did Philemon want to become when he was young?", answer="Engineer")
train_example3 = Example(question="What did Philemon realize his curiosity was pushing him towards as he grew older?", answer="Sciences")
train_example4 = Example(question="How many years after graduation did Philemon spend working in the academic writing industry?", answer="Eight")
train_example5 = Example(question="What was one of the subjects that Philemon handled in academic writing assignments?", answer="Nursing")
train_example6 = Example(question="What caused the global academic system to go into hibernation?", answer="Covid")
train_example7 = Example(question="What year did the usual peak season fail to materialize?", answer="2021")
train_example8 = Example(question="When were ranking systems introduced to deny all other writers the chance to see available orders?", answer="2023")
train_example9 = Example(question="How many orders had Philemon completed by February 15, 2024?", answer="4")
train_example10 = Example(question="What was the main reason Philemon wanted to branch into other high-demand fields?", answer="Income")
